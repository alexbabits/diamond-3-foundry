...
contract TestDeployDiamond is StateDeployDiamond {
    ...
    function test1_HasThreeFacets() public {
        assertEq(facetAddressList.length, 3);
    }


    function test2_FacetsHaveCorrectSelectors() public {
    ...
    function test3_SelectorsAssociatedWithCorrectFacet() public {
        for (uint i = 0; i < facetAddressList.length; i++) {
            bytes4[] memory fromGenSelectors =  generateSelectors(facetNames[i]);
...
contract TestAddFacet1 is StateAddFacet1 {
    ...
    function test4_AddTest1FacetFunctions() public {
    ...
    function test5_CanCallTest1FacetFunction() public {
        // try to call function on new Facet
        Test1Facet(address(diamond)).test1Func10();
    }


    function test6_ReplaceSupportsInterfaceFunction() public {
...
// Test Facuet functionality
contract TestAddFacet2 is StateAddFacet2{

    function test7_AddTest2FacetFunctions() public {
        // check if functions added to diamond
    ...
    function test8_RemoveSomeTest2FacetFunctions() public {
    ...
    function test9_RemoveSomeTest1FacetFunctions() public {
    ...
    function test10_RemoveAllExceptDiamondCutAndFacetFunction() public {
...
contract TestCacheBug is StateCacheBug {
    ...
    function test11_NoCacheBug() public {
